      ...
      <div className="container">
        <div className="row">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a href="#"><i class="fas fa-gifts"/>Gift Boxes</a></NavLink>
              </li>
              <li>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a href="#"><i class="fab fa-artstation"/>Powder Shading</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-pencil-alt"/>Pencile Shading</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-pen-alt"/>Mandala Art</a>
              </li>
            </ul>
          </div>
