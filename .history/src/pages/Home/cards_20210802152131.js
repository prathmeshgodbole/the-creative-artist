...
<div className="area">
    <div className="container">
        <div className="row">
            ...
            <div className="col-md-4 ">
                <div className="card">
                <NavLink to='/gifts' exact><div className="img2"><img src={giftcard} alt='giftcard'></img></div></NavLink>
                    <div className="main-text">
                        <h2>Gift Cards</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. In doloribus pariatur nostrum quidem laudantium rem maiores ipsa explicabo eos praesentium eum eaque placeat, quas sint quod voluptates, dignissimos, non ab!</p>
                    </div>
            ...
            <div className="col-md-4 ">
                <div className="card">
                <NavLink to='/gifts' exact><div className="img2"><img src={giftbox} alt='giftbox'></img></div></NavLink>
                    <div className="main-text">
                        <h2>Photo Gallery</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. In doloribus pariatur nostrum quidem laudantium rem maiores ipsa explicabo eos praesentium eum eaque placeat, quas sint quod voluptates, dignissimos, non ab!</p>
                    </div>
            ...
            <div className="col-md-4 ">
                <div className="card">
                <NavLink to='/sketches' exact><div className="img2"><img src={powdershading} alt='powdershading'></img></div></NavLink>
                    <div className="main-text">
            ...
            <div className="col-md-4 ">
                <div className="card">
                <NavLink to='/sketches' exact><div className="img2"><img src={sketching} alt='pencilshading'/></div></NavLink>
                    <div className="main-text">
            ...
            <div className="col-md-4 ">
                <div className="card">
                <NavLink to='/sketches' exact><div className="img2"><img src={sketching} alt='pencilshading'/></div></
