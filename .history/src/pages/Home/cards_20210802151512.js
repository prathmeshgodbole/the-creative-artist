...
const Cards = () => {
    return ( <
        ...
        div className = "card" >
        <
        div className = "img2" > < img src = { giftbox }
        alt = 'giftbox' / > < /div> <
        ...
        NavLink to = '/gifts'
        exact > < i class = "cadbtn btn-primary" > Explore < /i></NavLink >
        <
        /div> < /
        div > <
        /div>
        ...
        div className = "card" >
        <
        div className = "img2" > < img src = { giftcard }
        alt = 'giftcard' / > < /div> <
        div className = "main-text" >
        <
        ...
        p > Lorem, ipsum dolor sit amet consectetur adipisicing elit.In doloribus pariatur nostrum quidem laudantium rem maiores ipsa explicabo eos praesentium eum eaque placeat, quas sint quod voluptates, dignissimos, non ab! < /p> <
        NavLink to = '/gifts'
        exact > < i class = "btn btn-primary" > Explore < /i></NavLink >
        <
        /div> < /
        div > <
        /div>
        ...
        div className = "card" >
        <
        div className = "img2" > < img src = { powdershading }
        alt = 'powdershading' > < /img></div >
        <
        div className = "main-text" >
        <
        ...
        div className = "card" >
        <
        div className = "img2" > < img src = { sketching }
        alt = 'pencilshading' / > < /div> <
        div className = "main-text" >
        <
