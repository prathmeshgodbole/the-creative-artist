    ...
    <div className="container">
        <div className="row">
            ...
            <div className="col-md-4 ">
                <div className="card">
                    <div className="img2"><img src={giftbox} alt='giftbox'/></div>
            ...
            <div className="col-md-4 ">
                <div className="card">
                    <div className="img2"><img src={giftcard} alt='giftcard'/></div>
                    <div className="main-text">
            ...
            <div className="col-md-4 ">
                <div className="card">
                    ...
                    <div className="main-text">
                        <h2>Mandala Art</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. In doloribus pariatur nostrum quidem laudantium rem maiores ipsa explicabo eos praesentium eum eaque placeat, quas sint quod voluptates, dignissimos, non ab!</p>
                        <NavLink to='/sketches' exact><i class="btn btn-primary" style={text-decoration:none}>Explore</i></NavLink>
                    </div>
                </div>
            </div>
