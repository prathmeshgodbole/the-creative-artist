      ...
      <div class="form">
        <div class="contact-info">
          ...
          <div class="info">
            ...
            <i class="facebook fab fa-facebook-f"></i> <p>Nivrutti Colony, Warananagar 416113, Maharashtra</p>
            </div>
            <div class="information">
            <i class="facebook fab fa-facebook-f"></i>  <p>thecreativeartist.com</p>
            </div>
            <div class="information">
            <i class="facebook fab fa-facebook-f"></i><p>7517065560</p>
            </div>
          </div>
